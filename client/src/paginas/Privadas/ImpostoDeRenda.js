        ...
        <h4 className="text-start m-2 text-center">
          ...
          <div className="d-flex justify-content-between mb-2">
            ...
            <div className="form-floating">
                      ...
                      <div className="form-floating">
                        <input name="valor" id="valor" type="number" class="form-control" placeholder="Valor" onChange={e => setCampoEstocasticoRapido(e.target.value)} />
                        <label for="valor">valor</label>
                      </div>
          </div>
          ...
          <h8 className="card text-start d-flex justify-content-center align-items-center fs-9" style={{width: "100px"}}>LENTA</h8>
            <div className="form-floating">
                      ...
                      <div className="form-floating">
                        <input name="valor" id="valor" type="number" class="form-control" placeholder="Valor" onChange={e => setCampoEstocasticoLento(e.target.value)} />
                        <label for="valor">valor</label>
                      </div>
          </div>
        </div>
